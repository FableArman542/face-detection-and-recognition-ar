...
from normalizer import normalize_face, put_glass, put_crown

glasses=cv2.imread('objects/glasses.png')
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > .5:
            ...
            if rotated is not None and rotated.shape[0] == 56 and rotated.shape[1] == 46:
                if do:
                    print("AQUIIIII")
                    cv2.imwrite("resources/arman/face" + str(c) + ".jpg", rotated)
                    c += 1
                    do = False
